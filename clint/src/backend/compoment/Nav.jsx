...
import { Speedometer,PencilSquare,BagCheck,AspectRatio,PersonLinesFill,Person, Images,Gear,PatchQuestion,FastForwardBtnFill } from 'react-bootstrap-icons';
    ...
    <>
        <div className="sidenav">
            <ul>
                ...
                <li> <Link to="/allblog"> <PencilSquare/>  Blogs </Link>  </li>
                <li>  <Link to="/product">  <BagCheck/> Product </Link>  </li>
